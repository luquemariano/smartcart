...
F17 — Offline/PWA técnicamente validada contra PostgreSQL Docker: IndexedDB, cola autenticada, sync idempotente, concurrencia, rollback, mapping Product/Item, finish y PriceObservation. La prueba manual DevTools offline del usuario sigue pendiente. No incluye Background Sync, offline Promotions, push, colaboración ni F18/F19.
